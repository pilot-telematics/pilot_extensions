Ext.define('Store.communal.Tree', {
    ...
    initComponent: function () {
        ...
        this.tooltip = l('Objects');
        this.title = l('Objects');
        this.tools = [
            {
                iconCls: 'fa fa-gear',
                xtype: 'button'
            ...
            },
            {
                ...
                items: [{
                    ...
                    handler: function (tree, rowIndex, colIndex, item, e, record) {
                        pilot_confirm(
                            l('Delete'),
                            l('Do you really want to delete object') + ' <b>' + record.get('name') + '</b> ' + l('and all nested elements?'),
                            'delete_icon',
                            function () {
                                record.erase({
                                    success: function () {
                                    ...
                                    failure: function () {
                                        ...
                                        Ext.Msg.alert(l('Error'), l('Failed to delete'));
                                    }
                                });
                            },
                            'ext_com_tree_del'
